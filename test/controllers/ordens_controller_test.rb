...
class OrdensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden" do
    assert_difference('Orden.count') do
      post ordens_url, params: { orden: { cantidad: @orden.cantidad, precio_venta: @orden.precio_venta, producto_id: @orden.producto_id } }
    end
  ...
  test "should update orden" do
    patch orden_url(@orden), params: { orden: { cantidad: @orden.cantidad, precio_venta: @orden.precio_venta, producto_id: @orden.producto_id } }
